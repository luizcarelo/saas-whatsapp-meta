...
echo "== Etapa 46: Relatorio operacional exportavel =="
...
echo "Atualizando backend de auditoria com exportacao..."
...
echo "Garantindo modulo de auditoria no app.module.ts..."
...
if "OperationalAuditModule" not in text.split("imports: [", 1)[1].split("]", 1)text = text.replace(
        "imports: [",
...
echo "Atualizando frontend com botoes de exportacao..."
...
echo ""
echo "== Etapa 46 concluida com sucesso =="
echo ""
echo "Resumo:"
