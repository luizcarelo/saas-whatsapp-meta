...
echo "== Etapa 38: Validacao de assinatura dos webhooks da Meta =="
...
echo "Criando raw-body.middleware.ts..."
...
echo "Atualizando main.ts para preservar raw body..."
...
echo "Atualizando meta-webhooks.types.ts..."
...
echo "Atualizando meta-webhooks.service.ts..."
...
docker compose config > "${LOGS_DIR}/setup_38_docker_compose_config.log"
...
VERIFY_CHALLENGE="challenge_38_${STAMP}"
      ...
      "changes": [
        {
          ...
          "value": {
            ...
            "metadata": {
              ...
              "phone_number_id": "phone_signature_38_${STAMP}"
            },
            "contacts": [
              {
                "wa_id": "552188883838",
            ...
            "messages": [
              {
                "from": "552188883838",
                "id": "wamid.signature.etapa38.${STAMP}",
                "timestamp": "1760000000",
                "type": "text",
                "text": {
                  "body": "Mensagem assinada etapa 38"
                }
              }
            ]
          }
...
echo ""
echo "== Etapa 38 concluida com sucesso =="
echo ""
echo "Resumo:"
