...
FIX_LOG_FILE="${LOGS_DIR}/fix_38_nest_raw_body_native.log"
...
echo "== Correcao Etapa 38: rawBody nativo do Nest =="
...
echo "Atualizando main.ts para rawBody nativo do Nest..."
...
echo "Mantendo raw-body.middleware.ts apenas com tipo auxiliar..."
...
docker compose config > "${LOGS_DIR}/fix_38_nest_raw_body_native_docker_compose_config.log"
...
VERIFY_CHALLENGE="challenge_38_native_${STAMP}"
      ...
      "changes": [
        {
          ...
          "value": {
            ...
            "metadata": {
              ...
              "phone_number_id": "phone_signature_38_native_${STAMP}"
            },
            "contacts": [
              {
                "wa_id": "552188883838",
                "profile": {
                  "name": "Contato Assinatura Etapa 38 Native"
                }
              }
            ],
            "messages": [
              {
                "from": "552188883838",
                "id": "wamid.signature.native.etapa38.${STAMP}",
                "timestamp": "1760000000",
                "type": "text",
                "text": {
                  "body": "Mensagem assinada etapa 38 native"
                }
              }
            ]
          }
...
Foi adotado rawBody nativo do Nest.

Isso remove a necessidade de middleware manual para preservar o corpo bruto.
...
- logs/fix_38_nest_raw_body_native.log
- logs/setup_38.log
...
Etapa: 38
Acao: Correcao rawBody nativo Nest
