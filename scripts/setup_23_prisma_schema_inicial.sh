...
DOCKER_BUILD_LOG="${LOGS_DIR}/setup_23_backend_docker_build.log"
DOCKER_UP_LOG="${LOGS_DIR}/setup_23_backend_docker_up.log"
...
echo "== Etapa 23: Schema inicial do banco com Prisma =="
...
echo "Validando containers de banco..."
...
echo "Criando schema.prisma inicial..."
...
echo "Validando HTML indevido no schema..."
...
echo ""
echo "== Etapa 23 concluida com sucesso =="
echo ""
echo "Resumo:"
